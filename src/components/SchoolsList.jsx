...
const SchoolsList = () => {
  ...
  const handleRowClick = (school, index) => {
    // Since your API doesn't return schoolId in the e  vents endpoint,
    ...
    // const schoolId = school.schoolId1 || school._id || index
    const schoolId =
  typeof school.schoolId === "object"
    ? school.schoolId._id
    : school.schoolId || school._id || index;
